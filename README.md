...
> 目前正在進行全面重寫，發布日期尚未確定。如需更多資訊，請參閱 [`pre.30`](https://github.com/ExpTechTW/TREM/tree/pre.30) 分支。  
> As a result of recent API changes, certain functionalities in TREM may not operate as intended.  
> A full rewrite is presently underway, with the release date yet to be determined. For further information, please refer to [`pre.30`](https://github.com/ExpTechTW/TREM/tree/pre.30) branch.
